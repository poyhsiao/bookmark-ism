...
class OptionsPage {
  ...
  bindEvents() {
    ...
    document.getElementById('help-link').addEventListener('click', (e) => {
      e.preventDefault();
      chrome.tabs.create({ url: 'https://github.com/yourusername/bookmark-sync-service/wiki' });
    });

    document.getElementById('privacy-link').addEventListener('click', (e) => {
      e.preventDefault();
      chrome.tabs.create({ url: 'https://github.com/yourusername/bookmark-sync-service/blob/main/PRIVACY.md' });
    });

    document.getElementById('feedback-link').addEventListener('click', (e) => {
      e.preventDefault();
      chrome.tabs.create({ url: 'https://github.com/yourusername/bookmark-sync-service/issues' });
    });
  }
  ...
  async clearCache() {
    ...
    try {
      await chrome.storage.local.remove([STORAGE_KEYS.BOOKMARKS_CACHE]);
